...
function Header() {
  ...
  return (
    <div className="w-full h-[70px] md:h-[98px] inline-block bg-text-color-two fixed p-0 top-[-2px] left-0 right-0 z-50 ">
      {/* <Container> */}
      <div className="w-full  px-6 py-4 md:px-[62px] md:py-6 lg:px-[104px] lg:max-w-[1440px]  mx-auto">
